...
Схема: **GPT-4.1 mini → полный текст статьи → DeepSeek → GPT-4.1 mini → Telegram**.

- **GPT-4.1 mini** (`gpt-4.1-mini-2025-04-14`) ищет свежие статьи и возвращает ссылки с источниками.
...
поиск резервирует $0,025, проверка — $0,01056. Прежние расходы сохраняются.
...
| \*\*Dubai News Collector\*\* | Каждый час | Обработка ссылок GPT-4.1 mini; новый поиск не чаще дневного лимита |
