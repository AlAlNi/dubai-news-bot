...
MOUNTED_BUCKET_PATH = "/function/storage/dubai_news"
...
2) Политика и конфликты. Является ли основная тема большой политикой, войной, протестами, наркотиками, индией? Если да — ОТКЛОНИТЬ.
